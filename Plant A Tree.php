...
<html>
    ...
    <body>
		...
		<div class="tree-plant">
				...
				<p>"A tree is the best friend of man on earth." When we use trees respectfully and economically, 
					we have one of the greatest resources on earth. Trees are rightfully called the 'lungs of the earth.' Life on earth would cease to exist in the absence of trees. Trees are responsible for sustaining the environment in several ways.</p>
    ...
    <div class="accordion">
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    <p>Yes of cause you can.Giving a tree to someone is a thoughtful and long-lasting way to express your gratitude. Make someone happy by letting them know they're working to make the world a better place.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    <p>Yes of cause you can.You can get plants from us online.
                    </p>
                </div>
            </div>
        </div>
